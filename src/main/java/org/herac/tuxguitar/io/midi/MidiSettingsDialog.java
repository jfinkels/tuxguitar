...
public class MidiSettingsDialog {
  ...
  public MidiSettings open() {
    ...
    final Combo transposeCombo = new Combo(trackGroup, SWT.DROP_DOWN
        | SWT.READ_ONLY);
    transposeCombo
    ...
    buttonOK.addSelectionListener(new SelectionAdapter() {
      public void widgetSelected(SelectionEvent arg0) {
        ...
        MidiSettingsDialog.this.settings
            .setTranspose((MIN_TRANSPOSE + transposeCombo.getSelectionIndex()));
        dialog.dispose();
      }
    });
    ...
    return ((this.status == STATUS_ACCEPTED) ? MidiSettingsDialog.this.settings
        : null);
  }
}
