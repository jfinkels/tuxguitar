...
public class FileToolItems extends ToolItems {
  ...
  public void loadIcons() {
    ...
    this.saveAsSong.setImage(TuxGuitar.instance().getIconManager()
        .getFileSaveAs());
    this.printSong.setImage(TuxGuitar.instance().getIconManager()
        .getFilePrint());
    this.printPreviewSong.setImage(TuxGuitar.instance().getIconManager()
        .getFilePrintPreview());
  }
  ...
  public void loadProperties() {
    ...
    this.printPreviewSong.setToolTipText(TuxGuitar
        .getProperty("file.print-preview"));
  }
  ...
  public void showItems(ToolBar toolBar) {
    ...
    this.openSong.addSelectionListener(TuxGuitar.instance().getAction(
        OpenFileAction.NAME));

    this.saveSong = new ToolItem(toolBar, SWT.PUSH);
    this.saveSong.addSelectionListener(TuxGuitar.instance().getAction(
        SaveFileAction.NAME));

    this.saveAsSong = new ToolItem(toolBar, SWT.PUSH);
    this.saveAsSong.addSelectionListener(TuxGuitar.instance().getAction(
        SaveAsFileAction.NAME));

    this.printSong = new ToolItem(toolBar, SWT.PUSH);
    this.printSong.addSelectionListener(TuxGuitar.instance().getAction(
        PrintAction.NAME));

    this.printPreviewSong = new ToolItem(toolBar, SWT.PUSH);
    this.printPreviewSong.addSelectionListener(TuxGuitar.instance().getAction(
