...
public class CompositionToolItems extends ToolItems {
  ...
  public void loadProperties() {
    ...
    this.timeSignature.setToolTipText(TuxGuitar
        .getProperty("composition.timesignature"));
    ...
    this.repeatAlternative.setToolTipText(TuxGuitar
        .getProperty("repeat.alternative"));
  }
  ...
  public void update() {
    ...
    this.repeatClose.setSelection(measure != null
        && measure.getRepeatClose() > 0);
    this.repeatAlternative.setEnabled(!running);
    this.repeatAlternative.setSelection(measure != null
