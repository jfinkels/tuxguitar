...
public class MarkerMenuItem extends MenuItems {
  ...
  public void loadProperties() {
    ...
    setMenuItemTextAndAccelerator(this.list, "marker.list",
        ListMarkersAction.NAME);
    setMenuItemTextAndAccelerator(this.first, "marker.first",
        GoFirstMarkerAction.NAME);
    setMenuItemTextAndAccelerator(this.last, "marker.last",
        GoLastMarkerAction.NAME);
    setMenuItemTextAndAccelerator(this.previous, "marker.previous",
        GoPreviousMarkerAction.NAME);
    setMenuItemTextAndAccelerator(this.next, "marker.next",
        GoNextMarkerAction.NAME);
  }

  public void showItems() {
    // --ADD--
    this.add = new MenuItem(this.menu, SWT.PUSH);
    this.add.addSelectionListener(TuxGuitar.instance().getAction(
        AddMarkerAction.NAME));

    // --LIST--
    this.list = new MenuItem(this.menu, SWT.PUSH);
    this.list.addSelectionListener(TuxGuitar.instance().getAction(
        ListMarkersAction.NAME));
