...
public class ArgumentParser {
  ...
  private static final String[] OPTION_JRE_INFO = new String[] { "-i",
      "--system-info" };
  private static final String[] OPTION_VERSION = new String[] { "-v",
      "--version" };
  ...
  private void checkProperties() {
    for (int i = 0; i < this.arguments.length; i++) {
      ...
      if (indexKey == 0 && indexValue > indexKey
          && (indexValue + 1) < this.arguments[i].length()) {
