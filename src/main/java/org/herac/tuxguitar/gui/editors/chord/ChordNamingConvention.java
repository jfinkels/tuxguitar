...
public class ChordNamingConvention {
  ...
  public String createChordName(int chordTonic, int chordIndex, int alteration,
    ...
    // String chordName =
    // ((ChordInfo)ChordCreatorUtil.getChordData().getChords().get(chordIndex)).getName();
    ...
    if (alteration != 0) {
      ...
      switch (alteration) {
      case 1:
        sb.append(getAdd("9", plusMinus));
        break;
      case 2:
        sb.append(getAdd("11", plusMinus));
        break;
      case 3:
        sb.append(getAdd("13", plusMinus));
        break;
      }
