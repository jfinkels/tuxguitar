...
public class TrillEditor extends SelectionAdapter {
  ...
  public TGEffectTrill show(final TGNote note) {
    ...
    this.sixtyFourthButton.setImage(TuxGuitar.instance().getIconManager()
    ...
    this.thirtySecondButton.setImage(TuxGuitar.instance().getIconManager()
    ...
    this.sixTeenthButton.setImage(TuxGuitar.instance().getIconManager()
