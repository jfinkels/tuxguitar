...
public class StrokeEditor extends SelectionAdapter {
  ...
  public void open(final TGBeat beat) {
    ...
    this.duration64.setImage(TuxGuitar.instance().getIconManager().getDuration(
    ...
    this.duration32.setImage(TuxGuitar.instance().getIconManager().getDuration(
        TGDuration.THIRTY_SECOND));
    ...
    this.duration16.setImage(TuxGuitar.instance().getIconManager().getDuration(
    ...
    this.duration8.setImage(TuxGuitar.instance().getIconManager().getDuration(
        TGDuration.EIGHTH));
    ...
    this.duration4.setImage(TuxGuitar.instance().getIconManager().getDuration(
        TGDuration.QUARTER));
