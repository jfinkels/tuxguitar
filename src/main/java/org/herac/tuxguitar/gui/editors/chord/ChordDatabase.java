...
/**
 * Stores the information about the chord name, structure and alteration
 * abilities into a list
 * 
...
public class ChordDatabase {
  ...
  // Major--------------------------
      ...
      // 7M--------------------------
      // hard-coded index used in ChordRecognizer, below comment
      // "determine seventh", line 315 now
      ...
      // 5--------------------------
      // index <last> hard-coded in ChordRecognizer line 220, so it is not so
      // unusual
