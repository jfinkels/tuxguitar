...
public class ChangeInfoAction extends Action {
  ...
  protected void setProperties(String name, String artist, String album,
    ...
    getSongManager().setProperties(name, artist, album, author, date,
  ...
  public void showDialog(Shell shell) {
    ...
    if (song != null) {
      ...
      commentsLabel
          .setText(TuxGuitar.getProperty("composition.comments") + ":");

      final Text commentsText = new Text(group, SWT.BORDER | SWT.MULTI
          ...
          try {
            TGSynchronizer.instance().runLater(new TGSynchronizer.TGRunnable() {
              public void run() throws Throwable {
                ...
                setProperties(name, artist, album, author, date, copyright,
                    writer, transcriber, comments);
