...
public class ChangeTripletFeelAction extends Action {
  ...
  protected int getSelectedTripletFeel(Button tripletFeelNone,
      Button tripletFeelEighth, Button tripletFeelSixteenth) {
  ...
  public void showDialog(Shell shell) {
    ...
    if (measure != null) {
      ...
      tripletFeelNone.setText(TuxGuitar
          .getProperty("composition.tripletfeel.none"));
      tripletFeelNone
          .setSelection(measure.getTripletFeel() == TGMeasureHeader.TRIPLET_FEEL_NONE);

      final Button tripletFeelEighth = new Button(tripletFeel, SWT.RADIO);
      tripletFeelEighth.setText(TuxGuitar
          .getProperty("composition.tripletfeel.eighth"));
      tripletFeelEighth
          .setSelection(measure.getTripletFeel() == TGMeasureHeader.TRIPLET_FEEL_EIGHTH);

      final Button tripletFeelSixteenth = new Button(tripletFeel, SWT.RADIO);
      tripletFeelSixteenth.setText(TuxGuitar
          .getProperty("composition.tripletfeel.sixteenth"));
      tripletFeelSixteenth
          .setSelection(measure.getTripletFeel() == TGMeasureHeader.TRIPLET_FEEL_SIXTEENTH);
      ...
      toEnd
          .setText(TuxGuitar.getProperty("composition.tripletfeel.to-the-end"));
      ...
      buttonOk.addSelectionListener(new SelectionAdapter() {
        public void widgetSelected(SelectionEvent arg0) {
          ...
          final int tripletFeel = getSelectedTripletFeel(tripletFeelNone,
              tripletFeelEighth, tripletFeelSixteenth);
