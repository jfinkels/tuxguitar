...
public class TGShareFileDialog {
  ...
  protected void open(Shell shell) {
    ...
    dialog.setText(TuxGuitar
        .getProperty("tuxguitar-community.share-dialog.title"));

    Group group = new Group(dialog, SWT.SHADOW_ETCHED_IN);
    group.setLayout(makeGroupLayout(5));
    group.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true));
    group.setText(TuxGuitar
        .getProperty("tuxguitar-community.share-dialog.details"));

    // -------USERNAME---------------------------------
    Label usernameLabel = new Label(group, SWT.NULL);
    usernameLabel.setLayoutData(makeLabelData());
    usernameLabel.setText(TuxGuitar
        .getProperty("tuxguitar-community.share-dialog.details.user")
        + ":");

    final Text usernameText = new Text(group, SWT.BORDER | SWT.READ_ONLY);
    usernameText.setLayoutData(makeUsernameTextData());
    usernameText.setText(TGCommunitySingleton.getInstance().getAuth()
        .getUsername());
    ...
    titleLabel.setText(TuxGuitar
        .getProperty("tuxguitar-community.share-dialog.details.title")
        + ":");
    ...
    tagkeysLabel.setText(TuxGuitar
        .getProperty("tuxguitar-community.share-dialog.details.tagkeys")
        + ":");
    ...
    descriptionLabel.setText(TuxGuitar
        .getProperty("tuxguitar-community.share-dialog.details.description")
        + ":");

    final Text descriptionText = new Text(group, SWT.BORDER | SWT.MULTI
    ...
    buttonOK.addSelectionListener(new SelectionAdapter() {
      public void widgetSelected(SelectionEvent arg0) {
        update(titleText.getText(), tagkeysText.getText(), descriptionText
            .getText());
