...
public class MidiSettings {
  ...
  private void applyDoubleProperty(String property) {
    ...
    if (newValue != oldValue) {
      ...
      this.restartSynth = (this.restartSynth || !this.getSynth()
          .isRealtimeProperty(property));
    }
  }
  ...
  public double getDoubleValue(String property) {
    return getConfig().getDoubleConfigValue(property,
        this.getSynth().getDoubleProperty(property));
  }

  public int getIntegerValue(String property) {
    return getConfig().getIntConfigValue(property,
  ...
  public String getStringValue(String property) {
    return getConfig().getStringConfigValue(property,
        this.getSynth().getStringProperty(property));
  }
