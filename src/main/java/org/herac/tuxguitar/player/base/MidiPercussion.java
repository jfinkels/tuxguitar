...
public class MidiPercussion {
  ...
  public static final MidiPercussion[] PERCUSSION_LIST = new MidiPercussion[] {
      ...
      new MidiPercussion(45, "Low Tom"), new MidiPercussion(46, "Open Hi-Hat"),
      ...
      new MidiPercussion(60, "Hi Bongo"), new MidiPercussion(61, "Low Bongo"),
      ...
      new MidiPercussion(68, "Low Agogo"), new MidiPercussion(69, "Cabasa"),
      ...
      new MidiPercussion(74, "Long Guiro"), new MidiPercussion(75, "Claves"),
